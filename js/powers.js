...
const FAMILIES = {
  ...
  greed:     { name: 'Greed',       cat: 'UTIL', adj: 'Gilded',   noun: 'Fortune',
    desc: 'XP gems are worth more, and kills can drop a bonus gem.', next: '+15% XP, +10% bonus-gem chance' },
...
const SYNERGIES_RAW = [
  ...
  ['magnet', 'greed',   'goldrush',      'Gold Rush',        'gems fly to you from across the arena, worth +25%'],
